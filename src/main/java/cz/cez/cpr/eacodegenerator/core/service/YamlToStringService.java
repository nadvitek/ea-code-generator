package cz.cez.cpr.eacodegenerator.core.service;

import cz.cez.cpr.eacodegenerator.core.util.YamlCreator;
...
import cz.cez.cpr.eacodegenerator.core.yaml.enums.SchemaFormat;
...
public class YamlToStringService {
	...
	private YamlCreator.YamlConsumer complexSchema(ComplexSchema schema, SrcCard srcCard, SchemaFormat fm) {
		return y -> y
				.ln(0, "# --- PATH ---", cnd(fm == SchemaFormat.NAME_FULL))
